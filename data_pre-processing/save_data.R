...
# Предположим, вы рассчитали стандартное отклонение вашей выборки,
# сохранили результат в переменную my_sd и хотите сохранить этот объект в файл "my_sd.RData".
# Какая команда позволит вам это сделать?
